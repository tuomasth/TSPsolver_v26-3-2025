...
public class TSP_Solver_UEF_241908 {
    ...
    static int maxSomIterations = 20; // should be more than 0 
    static double somLearningRate = 0.25;
    //static double additionalRandomSOMinputs = 0;
    static byte chromosomeInitType = 1;
    static int wantedPopulationSize = 8; // at the start, can change later like other evol. variables
    static int wantedPopulationSizeOriginal;
    static double terminationPercentRequirement = 1.1; // % from best-known opt allowed to survive terminating, 1 = 0%, 1.05 = 5% etc.
    static int wantedEvolutionIterations = 3;
    static double probabilityOfCrossingOver = 0.4;
    static double wantedMutationRate = 0.009;
    static double elastic_band_limit = 1.001;
    static int wantedLogicStackSize = 6;
    static double movingPercentageForFragments = 0.15;
    static double wantedTourLength; // in evolutionary computing 
    static double shortestLengthOfTheOriginalChromosomes;
    ...
    /**
     * An idea, not implemented: set more of some additional Kohonen SOM inputs randomly.
     * @param input double
     */
    //public static void setAdditionalRandomSOMinputs(double input) {
    //    additionalRandomSOMinputs = input;
    //}
    
    /**
     * Set the chromosome initialization type (1 or 2). 
     * 1 = OPT-NNH-CHH-CHRI 
     * 2 = SOM-CH-NN 
     * @param input byte
     */
    public static void setChromosomeInitType(byte input) {
        chromosomeInitType = input;
    }
    
    /**
     * Set the probability of crossing-over.
     * @param input double
     */
    public static void setProbabilityOfCrossingOver(double input) {
        probabilityOfCrossingOver = input;
    }
     ...
     * @param input double
     */
    public static void setWantedMutationRate(double input) {
        wantedMutationRate = input;
    }
    
    /**
     * Set the "elastic band limit". Avoids including some individuals to the population.
     * @param input double
     */
    public static void setElasticBandLimit(double input) {
        elastic_band_limit = input;
    }
    
    /**
     * Get the "elastic band limit".
     * @return elastic_band_limit double
     */
    public static double getElasticBandLimit() {
        return elastic_band_limit;
    }
    
    /**
     * Set the wanted tour length.
     * @param input double
     */
    public static void setWantedTourLength(double input) {
        wantedTourLength = input;
    }
    
    /**
     * Get the wanted tour length.
     * @return wantedTourLength double
     */
    public static double getWantedTourLength() {
        return wantedTourLength;
    }
    
    /**
     * Set the shortest length of the original chromosomes.
     * @param input double
     */
    public static void setShortestLengthOfTheOriginalChromosomes(double input) {
        shortestLengthOfTheOriginalChromosomes = input;
    }
    
    /**
     * Get the shortest length of the original chromosomes.
     * @return shortestLengthOfTheOriginalChromosomes double
     */
    public static double getShortestLengthOfTheOriginalChromosomes() {
        return shortestLengthOfTheOriginalChromosomes;
    }
    
    /**
     * Set the termination % requirement.
     * @param input double
     */
    public static void setTerminationPercentRequirement(double input) {
        terminationPercentRequirement = input;
    }
    
    /**
     * Get the termination % requirement.
     * @return terminationPercentRequirement double
     */
    public static double getTerminationPercentRequirement() {
        return terminationPercentRequirement;
    }
    
    /**
     * Set the wanted population size.
     * @param input int
     */
    public static void setWantedPopulationSize(int input) {
        wantedPopulationSize = input;
    }
    
    /**
     * Set the original wanted population size.
     * @param input int
     */
    public static void setWantedPopulationSizeOriginal(int input) {
        wantedPopulationSizeOriginal = input;
    }
    
    /**
     * Set the logic stack size.
     * @param input int
     */
    public static void setWantedLogicStackSize(int input) {
        wantedLogicStackSize = input;
    }
    
    /**
     * Set the moving % for fragments.
     * @param input double
     */
    public static void setMovingPercentageForFragments(double input) {
        movingPercentageForFragments = input;
    }
    
    /**
     * Get the moving % for fragments.
     * @return movingPercentageForFragments double
     */
    public static double getMovingPercentageForFragments() {
        return movingPercentageForFragments;
    }
    
    /**
     * Set the wanted iteration count for the evolution.
     * @param input int
     */
    public static void setWantedEvolutionIterations(int input) {
        wantedEvolutionIterations = input;
    }
    
    /**
     * Set the triple-Opt pre result String.
     * @param input String
     */
    public static void setOPT3preResult(String input) {
        opt3preResult = input;
    }
    
    /**
     * Add String value to the Triple-Opt pre result.
     * @param input String
     */
    public static void addToOPT3preResult(String input) {
        opt3preResult += input;
    }
     ...
     * If the matching is 100%:tly optimized, then 1.5 is guaranteed. 
     ...
     * 
     * The SOM used here is not for actual machine learning purposes, the algorithm 
     * logic itself for clustering is the focus (and is for solving the TSP).
     * 
    ...
    public static String SOM_CH_NN_Algorithm(String input) {
        ...
        if(inputresult.equals("ok") && max >=4 && EUC_2D && 
            ...
            maxNeighbourhoodRadius = maxPossibleDistanceInHullAvgs/1.5;
            ...
            /*
            If more clusters wanted, just set some extra circumference vertices like this: 
            circumferenceVertices[j] = true;
            ...
            */
            ...
            somResultArray = KohonenSOM.performSOM(maxSomIterations, maxPossibleDistanceInHullAvgs, 
                        ...
                        neuronCoordinateXs, neuronCoordinateYs, false, null, somLearningRate,
                        maxNeighbourhoodRadius); // no logic stacks 
            ...
            if(hamiltonian) {
                long endTime = System.nanoTime();
                System.out.println("\nTime SOM-CH-NN (millisec): " + (endTime - startTime)/1000000);
                System.out.println("Time SOM-CH-NN (sec, rounded down): " + (endTime - startTime)/1000000000 + "\n");
     ...
     * Uses opt moves with a stack in order to improve an already 
     * existing Hamiltonian TSP tour. The search can be adjusted. Even the 
     * 2-opts alone are good tools for improvements. There are re-orderings.
     ...
     * NNH is the least time-consuming, could reasonably be called for multiple times.
     * OPT computations are in the class Sub_algorithms.
     * 
     * @param text String
     * @return String
     */
    public static String OPT3_Algorithm(String text) {
        ...
        if(inputresult.equals("ok") && max >=4 && EUC_2D && 
            ...
            double[][] edges = Chromosome.formChromosome_OPT_NNH_CHH_CHRI(text, ERRORMSG,
            ...
            if(hamiltonian) {
                long endTime = System.nanoTime();
                System.out.println("\nTime TripleOPT (millisec): " + (endTime - startTime)/1000000);
                System.out.println("Time TripleOPT (sec, rounded down): " + (endTime - startTime)/1000000000 + "\n");
     ...
     * Since there is also the "OPT_SOM_CH_NN_EVO_Algorithm", this is only a call to that 
     * just with the boolean difference. The boolean's purpose is to 
    ...
    public static String SOM_CH_NN_EVO_Algorithm(String inputText) {
        return OPT_SOM_CH_NN_EVO_Algorithm(inputText, false);
    }
     ...
     * 
     * @param inputText String
     * @param callOptFinally boolean
     * @return String
     */
    public static String OPT_SOM_CH_NN_EVO_Algorithm(String inputText, boolean callOptFinally) {
        wantedTourLength = Double.MAX_VALUE;
        String solution = "";
        int min = 1;
        int max = 0; // amount of vertices, will be increased later below 
        String rows[] = new String[500000];    
        ...
        // (OPT-)SOM-CH-NN-EVO --- read, the algorithm starts if the input is ok.
        ...
        if(inputresult.equals("ok") && max >=4 && EUC_2D && 
            ...
            double[][][] edges = new double[500000][2][2];
            ...
            System.out.println(" Variables for evolution: \n"
                    + " Limit % of terminating: " + terminationPercentRequirement
                    ...
                    + ", Chromosome init type: " + chromosomeInitType + "\n");
            ...
            ArrayList coordinate_ids = new ArrayList();
            coordinates_x = new ArrayList();
            coordinates_y = new ArrayList();
            for(int j = 0; j < coordinates.size(); j++) {
                if(j%3 == 0) {
                    coordinate_ids.add(coordinates.get(j));
                }
            ...
            for(int id = 0; id < wantedPopulationSize; id++) {
                double[][] chromEdges;
                ArrayList arr;
                // chromEdges: value, isY?
                
                if(chromosomeInitType == 1) {
                        chromEdges = Chromosome.formChromosome_OPT_NNH_CHH_CHRI(inputText, ERRORMSG,
                                                i, rows, max, coordinate_ids,
                                                coordinates_x, coordinates_y);
                        arr = new ArrayList();
                        for(int j = 0; j < max+1; j++) {
                            arr.add(chromEdges[j][0]);
                            arr.add(chromEdges[j][1]);
                        }
                }
                else {
                    arr = Chromosome.formChromosome_SOM_CH_NN(somResultArray, maxSomIterations, 
                        maxPossibleDistanceInHullAvgs, inputCoordinateXs, inputCoordinateYs,
                        neuronCoordinateXs, neuronCoordinateYs, amountOfHullVertices,
                        edges, neuronCoordinateXsCopy, neuronCoordinateYsCopy, max, min, solutionArray, somLearningRate,
                        maxNeighbourhoodRadius);
                }
                
                System.out.println("\t\tNEW chromosome created: " + id + ", " + arr);
                ...
                for(int j = 0; j < arr.size() -2; j+=2) {
                    double distance = Sub_algorithms.Euclidean_distance(
                            ...
                            (double)arr.get(j+2), 
                            (double)arr.get(j+3));
                    //System.out.println("\t\tFrom " + arr.get(j) + " , " + arr.get(j+1));
                    //System.out.println("\t\tTo " + arr.get(j+2) + " , " + arr.get(j+3));
                    //System.out.println("\t\tADDING " + distance);
                    tour_length += distance;
                }
                System.out.println("\t\tLENGTH IS: " + tour_length);
                Chromosome c = new Chromosome(String.valueOf(id), arr); // now a new chromosome has been created, 
                // population = all instances of the class Chromosome 
            ...
            // continue the computing but with "neuronLogicStacks true" and termination loop
            ...
            for(int e = 0; e < wantedEvolutionIterations; e++) {
                for(int chro = 0; chro < wantedPopulationSize; chro++) {
                    ...
                    //if(chromosomeInitType != 1) {
                        somResultArray = KohonenSOM.performSOM(maxSomIterations, maxPossibleDistanceInHullAvgs, 
                                    inputCoordinateXs, inputCoordinateYs, 
                                    neuronCoordinateXs, neuronCoordinateYs, true, 
                                    (Chromosome) instances.get(chro), somLearningRate,
                                    maxNeighbourhoodRadius);
                        ...
                        for(int j = 0; j < amountOfHullVertices/2; j++) {
                            nnh_purpose_coordinates.add((double)edges[j][0][0]);
                            nnh_purpose_coordinates.add((double)edges[j][1][0]);
                            nnh_purpose_coordinates.add(j);
                            //System.out.println("Hull: " + (double)edges[j][0][0] + ", " + (double)edges[j][1][0] + ", " + j);
                        ...
                        double do_not_even_insert_if_over1 = shortestLengthOfTheOriginalChromosomes * elastic_band_limit;
                        double do_not_even_insert_if_over2 = tour_length * elastic_band_limit;
                        if(tour_length < do_not_even_insert_if_over1 && 
                           tour_length < do_not_even_insert_if_over2) { // do not even insert to the chromosomes if over the limit here 
                            tempC.setChromosomePoints(solutionArray);
                            instances.set(chro, tempC);
                        }
                        else {
                            System.out.println("Did not insert a tour with length " + tour_length);
                        }
                    //}
                }
                ...
                if(instances.size() > wantedPopulationSizeOriginal * 1.2) {
                    // population is getting large, stricter requirements 
                    if(terminationPercentRequirement * 0.999 > 1) {
                        terminationPercentRequirement = terminationPercentRequirement * 0.999;
                    }
                    System.out.println("\nA BIT STRICTER REQUIREMENTS because of overpopulating: " + wantedTourLength);
                }
                if(instances.size() > wantedPopulationSizeOriginal * 2.0) {
                    // population is getting larger, stricter requirements 
                    if(terminationPercentRequirement * 0.995 > 1) {
                        terminationPercentRequirement = terminationPercentRequirement * 0.995;
                    }
                    System.out.println("\nSTRICT REQUIREMENTS because of overpopulating: " + wantedTourLength);
                }
                if(instances.size() > wantedPopulationSizeOriginal * 4.0) {
                    // population is getting too large, stricter requirements 
                    if(terminationPercentRequirement * 0.95 > 1) {
                        terminationPercentRequirement = terminationPercentRequirement * 0.95;
                    }
                    System.out.println("\nVERY STRICT REQUIREMENTS because of overpopulating: " + wantedTourLength);
                }
                
                wantedTourLength = EvolutionaryParts.calculateFitness(instances,
                        terminationPercentRequirement); 
                ...
                for(int chro = 0; chro < instances.size(); chro++) {
                    ArrayList c_coordinates = ((Chromosome) instances.get(chro)).getChromosomePoints();
                    double eucDistOfChrom = 0;
                    for(int j = 0; j < ((Chromosome) instances.get(chro)).getChromosomePoints().size()-2; j+=2) {
                    ...
                    if(eucDistOfChrom > wantedTourLength) { 
                        ...
                        if((instances.size() > 5) && (((Chromosome) instances.get(chro)).getLength() > wantedTourLength)) { 
                            System.out.println("\nTERMINATING " + chro + " with length " + eucDistOfChrom + 
                                    ", wantedTourLength: " + wantedTourLength);
                            Chromosome.terminateChromosome((Chromosome) instances.get(chro));
                            instances.remove(instances.get(chro));
                            logicStackCopiesOfOriginals.remove(logicStackCopiesOfOriginals.get(chro));
                            chro--;
                ...
                //if(chromosomeInitType != 1) {
                    instances = EvolutionaryParts.selectWhatWillBePairedThenCrossingOverAndMutation(instances, logicStackCopiesOfOriginals,
                                                                                         probabilityOfCrossingOver, wantedMutationRate);
                //}
            ...
            for(int j = 0; j < instances.size(); j++) {
                ...
                if(tourLength < currentBest) {
                    ...
                    for(int k = 0; k < solutionArrayListTEMP.size(); k++) {
                        ...
                        //System.out.println(solutionArrayListTEMP.toString());
                        //System.out.println("Tour length was: " + tourLength);
                        //System.out.println("Choosing THE BEST of the remaining population: " + currentBest);
                    }
                }
            }
            ...
            if(callOptFinally) {
                ...
                double[][] answer = Sub_algorithms.MakeOptMoves(max, currentBest, solutionArrayList);
            ...
            if((tour_length2 < currentBest) && callOptFinally) {
            ...
            if(hamiltonian) {
                long endTime = System.nanoTime();
                System.out.println("\nTime (OPT-)SOM-CH-NN-EVO (millisec): " + (endTime - startTime)/1000000);
                System.out.println("Time (OPT-)SOM-CH-NN-EVO (sec, rounded down): " + (endTime - startTime)/1000000000 + "\n");
                    return hullResult + somSolution + "\nSolution: \n" + solution + 
