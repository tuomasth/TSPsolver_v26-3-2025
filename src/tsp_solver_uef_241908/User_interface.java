 ...
 * The editable one is, of course, for editing the graph. The others are history, results and instructions. 
...
public class User_interface extends javax.swing.JFrame {
    private final String VERSION = "v2.1.1 (2025)";
    ...
    private void jMenuItemLK3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemLK3ActionPerformed
        String result = TSP_Solver_UEF_241908.OPT3_Algorithm(
                jTextArea1.getText());
        jTextArea2.setText(result);
        if(result.contains("Solution")) {
            String[] resultSplitted = result.split("Solution:");
    ...
    private void jMenuItemLK_SOM_CH_NN_EVOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemLK_SOM_CH_NN_EVOActionPerformed
        ...
        txtfield1.setText(String.valueOf(TSP_Solver_UEF_241908.maxSomIterations)); // SOM iterations
        JTextField txtfield2 = new JTextField(5); 
        txtfield2.setText(String.valueOf(TSP_Solver_UEF_241908.somLearningRate)); // SOM start learning rate
        ...
        txtfield4.setText(String.valueOf(TSP_Solver_UEF_241908.chromosomeInitType)); // Chromosome init type
        JTextField txtfield5 = new JTextField(5); 
        //txtfield5.setText(String.valueOf(TSP_Solver_UEF_241908.wantedPopulationSize)); // Population start size
        txtfield5.setText(String.valueOf(20));
        JTextField txtfield6 = new JTextField(5); 
        txtfield6.setText(String.valueOf(TSP_Solver_UEF_241908.terminationPercentRequirement)); // Termination req 
        JTextField txtfield7 = new JTextField(5); 
        txtfield7.setText(String.valueOf(TSP_Solver_UEF_241908.wantedEvolutionIterations)); // Generation iterations
        JTextField txtfield8 = new JTextField(5); 
        txtfield8.setText(String.valueOf(TSP_Solver_UEF_241908.probabilityOfCrossingOver)); // Crossing-over prob
        JTextField txtfield9 = new JTextField(5); 
        txtfield9.setText(String.valueOf(TSP_Solver_UEF_241908.wantedMutationRate)); // Mutation rate
        JTextField txtfield10 = new JTextField(5); 
        txtfield10.setText(String.valueOf(TSP_Solver_UEF_241908.elastic_band_limit)); // Elastic band limiter
        JTextField txtfield11 = new JTextField(5); 
        txtfield11.setText(String.valueOf(TSP_Solver_UEF_241908.wantedLogicStackSize)); // Logic stack size
        JTextField txtfield12 = new JTextField(5); 
        txtfield12.setText(String.valueOf(TSP_Solver_UEF_241908.movingPercentageForFragments)); // Effectiven. of logic frag.
        ...
        JLabel label27 = new JLabel("- When there are less than 3 chromosomes, the terminating will stop on the current iteration.");
    	...
    	while(x == -1){
            ...
            switch(x){
                case 1:
                    ...
                    TSP_Solver_UEF_241908.setMaxSOMiterations(value1_fromTextField);
                    TSP_Solver_UEF_241908.setSOMlearningRate(value2_fromTextField);
                    //TSP_Solver_UEF_241908.setAdditionalRandomSOMinputs(value3_fromTextField);
                    TSP_Solver_UEF_241908.setChromosomeInitType(value4_fromTextField);
                    TSP_Solver_UEF_241908.setWantedPopulationSize(value5_fromTextField);
                    TSP_Solver_UEF_241908.setWantedPopulationSizeOriginal(value5_fromTextField);
                    TSP_Solver_UEF_241908.setTerminationPercentRequirement(value6_fromTextField);
                    TSP_Solver_UEF_241908.setWantedEvolutionIterations(value7_fromTextField);
                    TSP_Solver_UEF_241908.setProbabilityOfCrossingOver(value8_fromTextField);
                    TSP_Solver_UEF_241908.setWantedMutationRate(value9_fromTextField);
                    TSP_Solver_UEF_241908.setElasticBandLimit(value10_fromTextField);
                    TSP_Solver_UEF_241908.setWantedLogicStackSize(value11_fromTextField);
                    TSP_Solver_UEF_241908.setMovingPercentageForFragments(value12_fromTextField);
                    
                    // running the actual algorithm:
                    String result = TSP_Solver_UEF_241908.OPT_SOM_CH_NN_EVO_Algorithm(
